...
const Footer = () => {
    return (
        <footer className="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20 text-black text-center border-t border-primary">
            <div className="container mx-auto">
                <div className=" flex flex-col md:flex-row justify-center items-center">
                    <div className="w-full px-4 flex flex-row justify-center items-center text-center lg:w-3/12">
                        <div className="mb-10 w-full ">
                            ...
                            <p className="text-dark text-center flex items-center text-sm font-medium">
                    ...
                    <div className="w-full px-4 lg:w-2/12 justify-center">
                        <div className="mb-10 w-full">
                    ...
                    <div className="w-full px-4 justify-center lg:w-2/12">
                        <div className="mb-10 w-full">
                    ...
                    <div className="w-full px-4 mx-auto lg:w-2/12">
                        <div className="mb-10 w-full">
                    ...
                    <div className="w-full px-4 flex flex-row justify-center lg:w-3/12">
                        <div className="mb-10 w-full">
